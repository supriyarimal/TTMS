...
<div class="container-fluid packagecontainer">
        <img src="img/Packages1.png" alt="">
...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-3 room-right">
					...
					<a href="package-details.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="view btn">Details</a>
				</div>
