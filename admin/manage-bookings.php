					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
								<?php $sql = "SELECT a.*, b.MobileNumber, b.FullName, c.PackageName 
        FROM tblbooking a 
        INNER JOIN tblusers b ON a.UserEmail = b.EmailId 
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) { ?>
											<tr>
												...
												<td><a
														href="update-package.php?pid=<?php echo htmlentities($result->PackageId); ?>"><?php echo htmlentities($result->PackageName); ?></a>
												</td>
												<td><?php echo htmlentities($result->FromDate); ?> To
